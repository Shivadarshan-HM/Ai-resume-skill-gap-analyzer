                ...
                <form className="mt-8 space-y-4" onSubmit={handleSendOtp}>
                  ...
                  <label className="block"><span className="mb-2 block text-xs font-medium text-slate-500">Password</span>
                    <div className="relative">
                      <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" className="h-12 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 pr-10 text-sm text-slate-700 outline-none transition focus:ring-2 focus:ring-sky-400" />
